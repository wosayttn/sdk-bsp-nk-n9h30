...
void usb_hc_low_level_init(void)
{
    ...
    outpw(0xB0005000 + 0xC4, 0x160);  //HSUSBH->USBPCR0 = 0x160;   /* enable PHY 0          */
    outpw(0xB0005000 + 0xC8, 0x520);  //HSUSBH->USBPCR1 = 0x520;   /* enable PHY 1          */

    //USBH->HcMiscControl |= USBH_HcMiscControl_OCAL_Msk; /* Over-current active low  */
    //outpw(0xB0007000 + 0x204, inpw(0xB0007000 + 0x204) | (0x1ul << 3));
